        ...
        <div className="game-container flex" >
            ...
            <div className="game flex">
                {!isStarted ? <>
                    ...
                    {board.map((row, i) => <div className="row" key={`${i}id`} >
                        {row.map((cell, j) => <div key={`${j}id`} className="cell flex" onClick={() => handleTicks(i, j, [...board], setBoard, currPlayer, setCurrPlayer)} >{cell}</div>)}
                    </div>)}
